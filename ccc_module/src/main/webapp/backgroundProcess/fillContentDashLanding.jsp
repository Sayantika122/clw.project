...
<%
	...
	%>
		<div style="margin-top:2%;border-top:3px solid #97A0B3;border-radius:1%;">
			<h5 style="margin-top:1%;margin-left:1%;display:inline-block;">Pending Complaints <span style="font-size:16px;"><%=var%></span></h5>
				...
				<tbody>
					<%
						while(rs.next()){
							%>
								<tr>
									<td style="font-size:12px;color:#012970;font-weight:bold;"><%=rs.getString(1)==null?"":rs.getString(1)%></td>
